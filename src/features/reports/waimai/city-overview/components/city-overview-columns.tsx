...
/**
 * 毛利列颜色 className
 * v > 0 → 绿色；v < 0 → 红色；v === 0 或 null/undefined → 空字符串
 */
...
/**
 * 日期范围约束：当 startDate > endDate 时，将 endDate 重置为 startDate
 */
...
/**
 * 带 HelpCircle 图标和 Radix Tooltip 的列头组件
 */
  ...
  // ── H-K 线上盈亏 ─────────────────────────────────────────────────────────────
  {
    ...
    columns: [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='线上账单成本合计' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 120,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='线上账单毛利' />
        ),
        cell: ({ getValue }) => {
    ...
    columns: [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='消费订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 100,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='线上账单订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 120,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='T-n线上账单订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 130,
      },
    ...
    columns: [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='全量商家数' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 100,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家服务费>0商家数' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 140,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='线上账单毛利≥0商家数' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='消费GTV=0且商家服务费=0商家数' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 200,
      },
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='消费GTV>0且服务费=0商家数' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 190,
      },
    ...
    columns: [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='线上账单毛利<0交易商家毛利合计' />
        ),
        cell: ({ getValue }) => {
          const v = getValue<number | null>()
          return <span className={getProfitColorClass(v)}>{formatNumber(v)}</span>
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='毛利<0_代理' />
        ),
        cell: ({ getValue }) => {
          const v = getValue<number | null>()
          return <span className={getProfitColorClass(v)}>{formatNumber(v)}</span>
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='毛利<0_跑腿' />
        ),
        cell: ({ getValue }) => {
          const v = getValue<number | null>()
          return <span className={getProfitColorClass(v)}>{formatNumber(v)}</span>
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='毛利<0_商家配送' />
        ),
        cell: ({ getValue }) => {
          const v = getValue<number | null>()
          return <span className={getProfitColorClass(v)}>{formatNumber(v)}</span>
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='毛利<0_其他配送' />
        ),
        cell: ({ getValue }) => {
          const v = getValue<number | null>()
          return <span className={getProfitColorClass(v)}>{formatNumber(v)}</span>
    ...
    columns: [
      {
        accessorKey: 'gtv_b',
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='消费GTV原价B端' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 140,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='代理商补贴金额B端' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      ...
      },
      {
        accessorKey: 'gtv_c',
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='消费GTV原价C端' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 140,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='代理商补贴金额C端' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
    ...
    columns: [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家原因异常单合计' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家不接单订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 140,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家拒单订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 130,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家取消不告知订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 160,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家异常经营状态订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 170,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家配送延迟订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家少餐错餐订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='商家违规投诉订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 150,
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title='差评商家订单量' />
        ),
        cell: ({ getValue }) => formatNumber(getValue<number | null>()),
        minSize: 130,
      },
